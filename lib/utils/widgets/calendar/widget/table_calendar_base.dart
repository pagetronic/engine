...
import 'package:engine/utils/widgets/calendar/widget/widgets/calendar_core.dart';
        ...
        return SimpleGestureDetector(
          ...
          child: ValueListenableBuilder<double>(
            ...
            child: CalendarCore(
              ...
              onVisibleRange: (DateTimeRange range) {
                if (widget.onVisibleRange != null) {
                  widget.onVisibleRange!(range);
                }
              },
