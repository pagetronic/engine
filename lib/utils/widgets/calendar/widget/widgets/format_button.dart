...
import 'package:engine/utils/widgets/calendar/widget/shared/utils.dart' show CalendarFormat;
...
class FormatButton extends StatelessWidget {
  ...
  String get _formatButtonText =>
      showsNextFormat ? availableCalendarFormats[_nextFormat()]! : availableCalendarFormats[calendarFormat]!;
