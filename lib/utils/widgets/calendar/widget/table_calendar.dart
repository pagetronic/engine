...
import 'package:engine/utils/widgets/calendar/widget/customization/calendar_builders.dart';
import 'package:engine/utils/widgets/calendar/widget/customization/calendar_style.dart';
import 'package:engine/utils/widgets/calendar/widget/customization/days_of_week_style.dart';
import 'package:engine/utils/widgets/calendar/widget/customization/header_style.dart';
import 'package:engine/utils/widgets/calendar/widget/shared/utils.dart';
import 'package:engine/utils/widgets/calendar/widget/simple_gesture_detector.dart';
import 'package:engine/utils/widgets/calendar/widget/table_calendar_base.dart';
import 'package:engine/utils/widgets/calendar/widget/utils.dart';
import 'package:engine/utils/widgets/calendar/widget/widgets/calendar_header.dart';
import 'package:engine/utils/widgets/calendar/widget/widgets/cell_content.dart';
...
class TableCalendar<T> extends StatefulWidget {
  ...
  final void Function(DateTimeRange range)? onVisibleRange;
          ...
          ValueListenableBuilder<DateTime>(
            ...
            builder: (context, value, _) {
              return CalendarHeader(
                ...
                onHeaderTap: () {
                  showDatePicker(
                          context: context, initialDate: _focusedDay.value, firstDate: kFirstDay, lastDate: kLastDay)
                      .then((value) {
                    if (value != null) {
